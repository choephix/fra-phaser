...
{
  public static shockwave( params: { x, y, scale, alpha, scene, delay?, container? } )
  {
    let wave = params.scene.add.sprite( params.x, params.y, "wave" )
      .setRotation( 2.0 * Math.PI * Math.random() )
      .setScale( .05 * params.scale )
